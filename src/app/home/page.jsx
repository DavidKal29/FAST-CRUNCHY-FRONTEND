        ...
        <div className='flex flex-col gap-4 xl:gap-6 justify-center items-start w-full'>
          ...
          <div className='flex gap-2'>
            <button
              ...
              className={`cursor-pointer font-semibold text-white ${domicilio ? 'bg-yellow-600' : 'bg-black border-2 border-yellow-600'} rounded-[10px] px-4 py-1 text-sm md:text-[20px]`}
            >
              Envío a domicilio
            </button>
            ...
            <button
              ...
              className={`cursor-pointer font-semibold text-white ${!domicilio ? 'bg-yellow-500' : 'bg-black border-2 border-yellow-500'} rounded-[10px] px-4 py-1 text-sm md:text-[20px]`}
            >
              Para recoger
            </button>
          </div>
          ...
          <div className='flex flex-col justify-center items-center w-full gap-4'>
            ...
            <a
              href='/products'
              className='text-center bg-yellow-600 cursor-pointer text-white rounded-[20px] py-2 font-semibold w-full md:text-[20px]'
            >
              Empezar pedido {domicilio ? 'a domicilio' : 'para recoger'}
            </a>
          </div>
        </div>
