    ...
    return (
      <div className="bg-black min-h-screen flex flex-col lg:flex-row justify-center items-center p-4 lg:p-12 gap-6 lg:gap-24">
        ...
        <div className="flex flex-col justify-center items-center gap-6 lg:bg-yellow-600 lg:p-6 lg:rounded lg:gap-8">
          ...
          {/* Invitado */}
          <a href="/home" className="text-center text-[15px] lg:text-[20px] font-bold text-white cursor-pointer">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center gap-6">
            ...
            <p className="text-white text-center max-w-[16rem] sm:max-w-[20rem] md:max-w-[24rem]">
              ¿Olvidaste la contraseña? <a href="/forgotPassword" className="text-yellow-600 lg:text-yellow-200">Recuperar</a>
            </p>

            {/* Botón Iniciar Sesión */}
            <button className="rounded text-center font-bold bg-orange-500 lg:bg-white text-white lg:text-yellow-600 w-[16rem] sm:w-[20rem] md:w-[24rem] h-[3rem] cursor-pointer">
              Iniciar Sesión
            </button>
